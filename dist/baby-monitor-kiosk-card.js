const D = globalThis, q = D.ShadowRoot && (D.ShadyCSS === void 0 || D.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, K = /* @__PURE__ */ Symbol(), et = /* @__PURE__ */ new WeakMap();
let mt = class {
  constructor(t, s, i) {
...
const Ct = (e) => new mt(typeof e == "string" ? e : e + "", void 0, K), gt = (e, ...t) => {
...
const { is: xt, defineProperty: Ot, getOwnPropertyDescriptor: Pt, getOwnPropertyNames: Mt, getOwnPropertySymbols: It, getPrototypeOf: Nt } = Object, V = globalThis, it = V.trustedTypes, Lt = it ? it.emptyScript : "", Ut = V.reactiveElementPolyfillSupport, x = (e, t) => e, T = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Lt : null;
      break;
  ...
  return s;
} }, G = (e, t) => !xt(e, t), ot = { attribute: !0, type: String, converter: T, reflect: !1, useDefault: !1, hasChanged: G };
...
let v = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(x("properties"))) {
      const s = this.properties, i = [...Mt(s), ...It(s)];
  ...
  requestUpdate(t, s, i, o = !1, n) {
    if (t !== void 0) {
      ...
      if (o === !1 && (n = this[t]), i ??= r.getPropertyOptions(t), !((i.hasChanged ?? G)(n, s) || i.useDefault && i.reflect && n === this._$Ej?.get(t) && !this.hasAttribute(r._$Eu(t, i)))) return;
      this.C(t, s, i);
    }
...
v.elementStyles = [], v.shadowRootOptions = { mode: "open" }, v[x("elementProperties")] = /* @__PURE__ */ new Map(), v[x("finalized")] = /* @__PURE__ */ new Map(), Ut?.({ ReactiveElement: v }), (V.reactiveElementVersions ??= []).push("2.1.2");
const F = globalThis, nt = (e) => e, R = F.trustedTypes, rt = R ? R.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, _t = "$lit$", g = `lit$${Math.random().toFixed(9).slice(2)}$`, $t = "?" + g, Dt = `<${$t}>`, y = document, P = () => y.createComment(""), M = (e) => e === null || typeof e != "object" && typeof e != "function", J = Array.isArray, Tt = (e) => J(e) || typeof e?.[Symbol.iterator] == "function", z = `[ 	
...
const Ht = (e, t) => {
  ...
  for (let h = 0; h < s; h++) {
    const a = e[h];
    let d, u, c = -1, f = 0;
    for (; f < a.length && (r.lastIndex = f, u = r.exec(a), u !== null); ) f = r.lastIndex, r === k ? u[1] === "!--" ? r = at : u[1] !== void 0 ? r = ht : u[2] !== void 0 ? (bt.test(u[2]) && (o = RegExp("</" + u[2], "g")), r = _) : u[3] !== void 0 && (r = _) : r === _ ? u[0] === ">" ? (r = o ?? k, c = -1) : u[1] === void 0 ? c = -2 : (c = r.lastIndex - u[2].length, d = u[1], r = u[3] === void 0 ? _ : u[3] === '"' ? ct : lt) : r === ct || r === lt ? r = _ : r === at || r === ht ? r = k : (r = _, o = void 0);
    const m = r === _ && e[h + 1].startsWith("/>") ? " " : "";
    n += r === k ? a + Dt : c >= 0 ? (i.push(d), a.slice(0, c) + _t + a.slice(c) + g + m) : a + g + (c === -2 ? h : m);
  }
...
class I {
  constructor({ strings: t, _$litType$: s }, i) {
    ...
    this.parts = [];
    let n = 0, r = 0;
    const h = t.length - 1, a = this.parts, [d, u] = Ht(t, s);
    ...
    for (; (o = $.nextNode()) !== null && a.length < h; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const c of o.getAttributeNames()) if (c.endsWith(_t)) {
          ...
          a.push({ type: 1, index: n, name: U[2], strings: m, ctor: U[1] === "." ? jt : U[1] === "?" ? Bt : U[1] === "@" ? zt : j }), o.removeAttribute(c);
        ...
        if (bt.test(o.tagName)) {
          ...
          if (f > 0) {
            ...
            for (let m = 0; m < f; m++) o.append(c[m], P()), $.nextNode(), a.push({ type: 2, index: ++n });
            o.append(c[f], P());
          }
        }
...
function w(e, t, s = e, i) {
  ...
  return o?.constructor !== n && (o?._$AO?.(!1), n === void 0 ? o = void 0 : (o = new n(e), o._$AT(e, s, i)), i !== void 0 ? (s._$Co ??= [])[i] = o : s._$Cl = o), o !== void 0 && (t = w(e, o._$AS(e, t.values), o, i)), t;
}
class Vt {
  constructor(t, s) {
  ...
  u(t) {
    ...
    for (; a !== void 0; ) {
      if (r === a.index) {
        let d;
        a.type === 2 ? d = new L(n, n.nextSibling, this, t) : a.type === 1 ? d = new a.ctor(n, a.name, a.strings, this, t) : a.type === 6 && (d = new Wt(n, this, t)), this._$AV.push(d), a = i[++h];
      }
...
class L {
  ...
  _$AI(t, s = this) {
    t = w(this, t, s), M(t) ? t === l || t == null || t === "" ? (this._$AH !== l && this._$AR(), this._$AH = l) : t !== this._$AH && t !== S && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Tt(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  $(t) {
    const { values: s, _$litType$: i } = t, o = typeof i == "number" ? this._$AC(t) : (i.el === void 0 && (i.el = I.createElement(yt(i.h, i.h[0]), this.options)), i);
  ...
  k(t) {
    ...
    const s = this._$AH;
    let i, o = 0;
    for (const n of t) o === s.length ? s.push(i = new L(this.O(P()), this.O(P()), this, this.options)) : i = s[o], i._$AI(n), o++;
...
class j {
  ...
  _$AI(t, s = this, i, o) {
    ...
    let r = !1;
    if (n === void 0) t = w(this, t, s, 0), r = !M(t) || t !== this._$AH && t !== S, r && (this._$AH = t);
    else {
      const h = t;
      let a, d;
      for (t = n[0], a = 0; a < n.length - 1; a++) d = w(this, h[i + a], s, a), d === S && (d = this._$AH[a]), r ||= !M(d) || d !== this._$AH[a], d === l ? t = l : t !== l && (t += (d ?? "") + n[a + 1]), this._$AH[a] = d;
    }
    r && !o && this.j(t);
  }
  j(t) {
...
const vt = (e, t, s) => {
  ...
  if (o === void 0) {
    ...
    i._$litPart$ = o = new L(t.insertBefore(P(), n), n, void 0, s ?? {});
  }
  return o._$AI(e), o;
};
const Q = globalThis;
...
let N = class extends E {
  ...
  render() {
    ...
    return p`<div class=grid><label>Naam/ID<input .value=${e.id ?? ""} @change=${(i) => this.set("id", i.target.value)}></label>${this.entity("camera", "Camera entity", e.camera ?? "", ["camera"])}<label>go2rtc/WebRTC stream<input .value=${e.stream ?? ""} @change=${(i) => this.set("stream", i.target.value)}></label>${this.entity("sound_sensor", "Geluidsensor", e.sound_sensor ?? "", ["sensor", "binary_sensor"])}${[["sound_threshold_db", "Activeringsgrens dB"], ["sound_reset_db", "Resetgrens dB"], ["trigger_for", "Minimale geluidsduur (s)"], ["silence_duration", "Stiltetijd (s)"], ["manual_close_cooldown", "Cooldown handmatig sluiten (s)"]].map(([i, o]) => p`<label>${o}<input type=number .value=${String(e[i] ?? "")} @change=${(n) => this.set(i, Number(n.target.value))}></label>`)}${s("preload", "Stream voorverwarmen", e.preload !== !1)}${s("auto_open", "Automatisch openen", e.auto_open !== !1)}${s("kiosk.enabled", "Kioskmodus", e.kiosk?.enabled !== !1)}${s("kiosk.device_bound", "Alleen gekoppeld apparaat", e.kiosk?.device_bound !== !1)}<label>Toegestane HA-user-ID’s (komma-gescheiden)<input .value=${e.kiosk?.allowed_user_ids?.join(", ") ?? ""} @change=${(i) => this.set("kiosk.allowed_user_ids", i.target.value.split(",").map((o) => o.trim()).filter(Boolean))}></label>${s("audio.default_muted", "Standaard gedempt", e.audio?.default_muted ?? !1)}${s("audio.remember_state", "Audiostatus onthouden", e.audio?.remember_state !== !1)}${s("controls.mute", "Mute-knop tonen", e.controls?.mute !== !1)}${s("controls.close", "Sluitknop tonen", e.controls?.close !== !1)}${s("controls.volume", "Volumeknoppen tonen", e.controls?.volume ?? !1)}${s("controls.brightness", "Helderheidsknoppen tonen", e.controls?.brightness ?? !1)}${s("debug", "Debugstatus", !!e.debug)}<label>Companion notify service<input .value=${e.companion?.notify_service ?? ""} @change=${(i) => this.set("companion.notify_service", i.target.value)}></label>${[["active_brightness", "Actieve helderheid"], ["idle_brightness", "Rusthelderheid"], ["active_volume", "Actief volume"], ["idle_volume", "Rustvolume"]].map(([i, o]) => p`<label>${o}<input type=number min=0 max=100 .value=${String(e.companion?.[i] ?? "")} @change=${(n) => this.set(`companion.${i}`, Number(n.target.value))}></label>`)}<div class=pair><b>Dit apparaat gekoppeld: ${b(t) ? "ja" : "nee"}</b><button @click=${() => {
      b(t) ? wt(t) : St(t), this.requestUpdate();
...
const A = { preload: !0, trigger_for: 1, silence_duration: 5, manual_close_cooldown: 30, sound_threshold_db: 48, sound_reset_db: 42 };
function Zt(e, t) {
  switch (e) {
    case "IDLE":
...
class Yt {
  constructor(t, s) {
    this.config = t, this.key = s, this.listeners = /* @__PURE__ */ new Set(), this.lastLoud = !1, this.state = "IDLE", this.machine = new Xt((t.trigger_for ?? A.trigger_for) * 1e3, (t.silence_duration ?? A.silence_duration) * 1e3, (t.manual_close_cooldown ?? A.manual_close_cooldown) * 1e3, (i) => {
  ...
  update(t) {
    ...
    let n;
    if (i)
      n = this.lastLoud ? o > (this.config.sound_reset_db ?? A.sound_reset_db) : o >= (this.config.sound_threshold_db ?? A.sound_threshold_db);
    else {
...
var ie = Object.defineProperty, oe = Object.getOwnPropertyDescriptor, B = (e, t, s, i) => {
  for (var o = i > 1 ? void 0 : i ? oe(t, s) : t, n = e.length - 1, r; n >= 0; n--)
    (r = e[n]) && (o = (i ? r(t, s, o) : r(o)) || o);
  return i && o && ie(t, s, o), o;
};
let C = class extends E {
  ...
  connectRuntime() {
    this.unsubscribe?.(), this.runtime = te(this.config), this.unsubscribe = this.runtime.subscribe((e) => {
      this.machineState = e, this.requestUpdate(), W(this.configId, this) && (e === "ACTIVE" && (this.companion(!0), this.activateVideo()), (e === "IDLE" || e === "MANUAL_COOLDOWN") && this.companion(!1));
    });
  }
  connectedCallback() {
  ...
  async activateVideo() {
    ...
    e && se(e.userAgent, e.platform, e.maxTouchPoints) && (this.camera?.remove(), this.camera = void 0, this.cameraSignature = "", this.ensureCamera(), this.camera && (this.camera.hass = this.hass), this.syncPortal()), requestAnimationFrame(() => {
  ...
  syncPortal() {
    ...
    this.portal.style.cssText = e ? "position:fixed;inset:0;z-index:2147483000;opacity:1;pointer-events:auto;background:#000;display:grid;place-items:center;overflow:hidden;" : "position:fixed;inset:0;z-index:-1;opacity:.001;pointer-events:none;background:#000;display:grid;place-items:center;overflow:hidden;", vt(e || t ? p`<style>.cam{width:100%;height:100%;min-width:100vw;min-height:100vh}.controls{position:absolute;left:50%;bottom:max(24px,env(safe-area-inset-bottom));transform:translateX(-50%);display:flex;gap:12px;flex-wrap:wrap;justify-content:center}.controls button{width:68px;height:68px;border:0;border-radius:50%;font-size:25px;background:#111c;color:#fff}</style><div class=cam>${this.camera}</div>${e ? p`<div class=controls>${this.config.controls?.brightness ? p`<button aria-label="Helderheid lager" @click=${() => this.kioskLevel("brightness", -20)}>☀−</button><button aria-label="Helderheid hoger" @click=${() => this.kioskLevel("brightness", 20)}>☀+</button>` : l}${this.config.controls?.volume ? p`<button aria-label="Volume lager" @click=${() => this.kioskLevel("volume", -20)}>−🔊</button><button aria-label="Volume hoger" @click=${() => this.kioskLevel("volume", 20)}>+🔊</button>` : l}${this.config.controls?.mute !== !1 ? p`<button aria-label=${this.muted ? "Geluid aan" : "Geluid uit"} @click=${() => this.toggleMute()}>${this.muted ? "🔇" : "🔊"}</button>` : l}${this.config.controls?.close !== !1 ? p`<button aria-label="Sluiten" @click=${() => this.runtime?.close()}>✕</button>` : l}</div>` : l}` : l, this.portal);
  }
  togglePair() {
    b(this.configId) ? wt(this.configId) : St(this.configId), b(this.configId) && this.ensureCamera(), this.requestUpdate();
  }
  render() {
    if (!this.config) return l;
    const e = this.hass?.states[this.config.sound_sensor]?.state ?? "?", t = b(this.configId);
    return p`${this.config.show_setup ? p`<ha-card class="setup"><div><b>Baby Monitor Kiosk</b><div>Dit apparaat is ${t ? "gekoppeld" : "niet gekoppeld"}.</div></div><button @click=${() => this.togglePair()}>${t ? "Ontkoppelen" : "Koppel dit apparaat"}</button></ha-card>` : l}${!this.active() && this.config.preload === !1 ? p`<span class=idle>Baby monitor gereed</span>` : l}${this.config.debug ? p`<div class=debug>state=${this.machineState} | value=${e} | on≥${this.config.sound_threshold_db ?? "-"} | off≤${this.config.sound_reset_db ?? "-"} | timer=${Math.ceil((this.runtime?.remainingMs() ?? 0) / 1e3)}s | kiosk=${this.eligible()} | preload=${this.config.preload !== !1 && this.eligible()}</div>` : l}`;
  }
};
...
console.info("%c BABY-MONITOR-KIOSK-CARD %c 0.1.9 ", "color:white;background:#3949ab;font-weight:bold", "color:#3949ab;background:white");
